...
output_stack:list[Symbol] =[Symbol.from_float(1),Symbol.from_float(2),Symbol.from_float(4),Symbol.from_operator(operators["*"]),Symbol.from_operator(operators["+"]),Symbol.from_float(3),Symbol.from_operator(operators["-"])]
